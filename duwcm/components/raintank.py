...
class RainTankClass:
    ...
    Outflows: Evaporation, runoff sewer and impervious
    """
    ...
    def __init__(self, params: Dict[str, Dict[str, Any]], raintank_data: RainTankData):
        ...
        Args:
            params (Dict[str, Dict[str, Any]]): System parameters
                ...
                effective_outflow: Effective runoff from roof to impervious [%]
        ...
        self.raintank_data.flows.set_capacity(FlowProcess.REUSE, params['raintank']['capacity'] * raintank_total_ratio, 'L')
        ...
        self.raintank_data.effective_outflow = (1.0 if  params['impervious']['area'] == 0
    ...
    def solve(self, forcing: pd.Series) -> None:
        ...
        Updates flows with:
            ...
            to_impervious: Non-effective overflow to impervious [m³]

        Notes:
            - First flush is diverted to stormwater before storage
            - Overflow is split between stormwater and impervious based on effective_outflow ratio
        ...
        if data.storage.get_capacity('m3') == 0:
            ...
            runoff_impervious = system_outflow - runoff_stormwater

            # Update flows for zero capacity case
            data.flows.set_flow('to_stormwater', runoff_stormwater, 'm3')
            data.flows.set_flow('to_impervious', runoff_impervious, 'm3')
            return
